...
Public Class CancelProducts
    Private Sub CancelProducts_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub DateTimeFilter(ByVal start_date As String, ByVal end_date As String)
        Try
            ...
            grdCancelProducts.DataSource = Nothing
            grdCancelProducts.DataSource = datProducts
